...
?>
<div class="bs styletere stylefiv stylesix">
	<div class="bsx">
		...
		<div class="limit">
			...
			<?php echo GOV_manga::get_post_thumbnail(get_the_ID(),'full', 260, 190,array('title'=>get_the_title(),'alt'=>get_the_title())); ?>
		</div>
		</a>
		<div class="bigor">
			<div class="tt">
			...
			<?php if($serieslatest){
				...
				foreach ($serieslatest as $key => $value) {
					echo '<li><a href="'.chapter_url($value['permalink']).'">'.GOV_lang::get('mini_ch').' '.$value['chapter'].'</a> <span class="fivtime">'.human_time_diff($value['time'], current_time('timestamp')).'</span></li>';
				}
				echo '</ul>';
			} ?>
