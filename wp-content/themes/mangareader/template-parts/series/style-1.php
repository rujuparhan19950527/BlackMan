			...
			<div class="info-left-margin">	
				...
				<?php } ?>
					...
					<div class="tsinfo bixbox">
						...
						<?php } ?>
						<?php $meta = rwmb_get_value( 'ero_type' ); if($meta){ $slugseries = tsrs_get_manga_slug(); if( ! $slugseries){ $slugseries = 'manga'; } ?>
							<div class="imptdt">
								<?php echo GOV_lang::get('series_info_type_label')?> <a href="<?php bloginfo('url'); ?>/<?php echo $slugseries; ?>/?order=title&type=<?php echo $meta; ?>"><?php rwmb_the_value('ero_type'); ?></a>
							</div>
						<?php } ?>
						...
						<?php if (is_ts_series_view_count_enabled()) { ?>
							<div class="imptdt">
									<?php echo GOV_lang::get('series_info_views_label')?> <i><span class="ts-views-count">?</span></i>
							</div>
						<?php } ?>
					</div>
			</div>
